    ...
    stages {
        ...
        stage('Deploy to Minikube') {
            steps {
                ...
                sh 'kubectl --token=ZzczaHg5OWZoODNqZGsyamY5M2pka3c5M2tkajkyazM4ZGtjamQ5MzJkOWNqZGs5ODJqZGs5ODMyZGpjOThkMjM= apply -f resources/k8s/deployment-db.yaml'
                sh 'kubectl --token=ZzczaHg5OWZoODNqZGsyamY5M2pka3c5M2tkajkyazM4ZGtjamQ5MzJkOWNqZGs5ODJqZGs5ODMyZGpjOThkMjM= apply -f resources/k8s/service-db.yaml'
